...
Next we define the starting assumptions of \(k=0.001\), and \(r_0=4\), followed by a loop to iterator over the days, \(n\), until all 1000 people have heard the rumor.
